...
functionDictionary = {"Classes": Classes,
                      "print": print,
                      "float": float}
testCase1 = TestCase("case 1", "Classes", arguments={})
testCase2 = TestCase("case 2", "print", arguments={"Test"}, expected_std_output="Test")
testCase3 = TestCase("case 3", "float", arguments="1.5", expected_output=1.5)
testCase4 = TestCase("case 4", "float", arguments="failMe", expected_exception=ValueError)
