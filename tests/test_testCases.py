...
functionDictionary = {"Classes": Classes,
                      "print": print,
                      "float": float}
testCase1 = TestCase({None}, testCaseName="case 1", functionName="Classes")
testCase2 = TestCase({"Test"}, testCaseName="case 2", functionName="print", expected_std_output="Test")
