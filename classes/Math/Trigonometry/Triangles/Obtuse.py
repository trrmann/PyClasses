...
from Classes.Math.Geometry.Shapes.Triangles.Obtuse import ObtuseTriangle as GeometryObtuseTriangle,  ObtuseTriangleError as GeometryObtuseTriangleError
...
class ObtuseTriangle(ScaleneTriangle, GeometryObtuseTriangle):
    def __new__(cls, *args, **kwargs):
        return super().__new__(cls)
