...
class TestCase(Classes):
    ...
    def to_string(self, whitespace: bool=False):
        ...
        if (self.functionArguments != None) and (type(self.functionArguments)==type(str(""))): out = f"{out}{Fore.CYAN}, functionArguments=\"{Fore.GREEN}{self.functionArguments}{Fore.CYAN}\"{Style.RESET_ALL}"
        if (self.functionArguments != None) and (type(self.functionArguments)!=type(str(""))): out = f"{out}{Fore.CYAN}, functionArguments={Fore.GREEN}{self.functionArguments}{Style.RESET_ALL}"
        if self.functionKeyWordArguments != None: out = f"{out}{Fore.CYAN}, functionKeyWordArguments={Fore.GREEN}{self.functionKeyWordArguments}{Style.RESET_ALL}"
        if self.stdInInput != None: out = f"{out}{Fore.CYAN}, stdInInput=\"{Fore.GREEN}{self.stdInInput}{Fore.CYAN}\"{Style.RESET_ALL}"
