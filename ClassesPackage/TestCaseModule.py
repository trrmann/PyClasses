...
class TestCase(Classes):
    ...
    def to_string(self):
        ...
        if self.functionArguments != None: out = f"{out}, functionArguments=\"{self.functionArguments}\""
        if self.functionKeyWordArguments != None: out = f"{out}, functionKeyWordArguments=\"{self.functionKeyWordArguments}\""
        if self.expectedOutputValueOf != None: out = f"{out}, expectedOutputValueOf=\"{self.expectedOutputValueOf}\""
